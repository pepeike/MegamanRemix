...
public class PoopyGuy : MonoBehaviour
{
    ...
    [SerializeField]
    private JockDetection1 detection;
    private bool facingLeft = false;


    private void Awake() {
        detection = GetComponentInParent<JockDetection1>();
    ...
    private void FixedUpdate() {
        ...
        if (detection.target2 != null) {
            target = detection.target2;
        } else if (detection.target2 == null) {
            target = null;
        }

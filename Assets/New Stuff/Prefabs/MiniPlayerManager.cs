...
public class MiniPlayerManager : MonoBehaviour
{
    ...
    public Vector2 kickspot = new Vector2(65.194f, 15.27f);
    ...
    void Update()
    {
        ...
        isTouchingFront = Physics2D.OverlapCircle(frontCheck.position, .2f, jumpableGround);
    ...
    private void Jump()
    {
        RayPositionCenter = transform.position + new Vector3(0, -.2f, 0);
